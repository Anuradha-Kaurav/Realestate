...
/**
 * Created by shabbu on 9/9/2018.
 */

public class FileUtils {

    /** TAG for log messages. */
    static final String TAG = "CommonMethod";
    ...
    public class LocalStorageProvider extends DocumentsProvider {
        ...
        public static final String AUTHORITY = "com.globussoft.sayhello.chat.model.utils.documents";
        ...
        private final String[] DEFAULT_DOCUMENT_PROJECTION = new String[] {
                ...
                Document.COLUMN_FLAGS, Document.COLUMN_MIME_TYPE,
        ...
        public Cursor queryRoots(final String[] projection)
            ...
            row.add(DocumentsContract.Root.COLUMN_ICON, R.drawable.ic_person);
        ...
        public String createDocument(final String parentDocumentId,
            ...
            try {
                ...
                Log.e(LocalStorageProvider.class.getSimpleName(),
        ...
        public AssetFileDescriptor openDocumentThumbnail(final String documentId,
                                                         final Point sizeHint, final CancellationSignal signal)
                throws FileNotFoundException {
            ...
            try {
                tempFile = File.createTempFile("thumbnail", null, getContext()
                        .getCacheDir());
        ...
        @Override
        public Cursor queryDocument(final String documentId,
                                    final String[] projection) throws FileNotFoundException {
            // Create a cursor with either the requested fields, or the default
            // projection if "projection" is null.
            final MatrixCursor result = new MatrixCursor(
                    projection != null ? projection : DEFAULT_DOCUMENT_PROJECTION);
